  ...
  return (
    ...
    >
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          When you're ready, run <ThemedText type="defaultSemiBold">npm run reset-project</ThemedText> to get a fresh <ThemedText type="defaultSemiBold">app</ThemedText> directory.
