...
const barbellWeights: BarbellWeight[] = [
  ...
  },
  {
    ...
    description: "Common training bar for general use and skill work",
  },
  {
    id: "7",
    lbs: 18,
    kg: 8.2,
    label: "Training Bar",
    description: "Lightweight training bar for technique work",
  },
  {
    id: "8",
    lbs: 17,
  ...
  },
  {
    ...
    kg: 6.8,
    label: "Technique Bar",
    description: "Lightweight aluminum bar, used on form and technique work",
  },
];
